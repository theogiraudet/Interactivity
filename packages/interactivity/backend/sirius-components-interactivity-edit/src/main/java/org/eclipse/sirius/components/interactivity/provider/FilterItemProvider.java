...
public class FilterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InteractivityPackage.Literals.FILTER__FOCUS);
			childrenFeatures.add(InteractivityPackage.Literals.FILTER__RADIUS);
			childrenFeatures.add(InteractivityPackage.Literals.FILTER__DEFAULT_MODIFIER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(InteractivityPackage.Literals.FILTER__FOCUS,
				InteractivityFactory.eINSTANCE.createPath()));

		newChildDescriptors.add(createChildParameter(InteractivityPackage.Literals.FILTER__RADIUS,
				InteractivityFactory.eINSTANCE.createFixedRadius()));

		newChildDescriptors.add(createChildParameter(InteractivityPackage.Literals.FILTER__RADIUS,
				InteractivityFactory.eINSTANCE.createBoundedRadius()));

		newChildDescriptors.add(createChildParameter(InteractivityPackage.Literals.FILTER__DEFAULT_MODIFIER,
