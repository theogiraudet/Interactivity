 ...
 * @author tgiraudet
 */
@QueryDataFetcher(type = "Query", field = "semanticSearch")
public class SemanticSearchDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public SemanticSearchDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, SemanticSearchInput.class);
