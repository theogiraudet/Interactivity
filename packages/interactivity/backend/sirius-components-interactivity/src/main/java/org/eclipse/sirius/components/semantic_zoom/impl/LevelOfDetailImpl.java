 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.semantic_zoom.impl.LevelOfDetailImpl#getReferences <em>References</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.semantic_zoom.impl.LevelOfDetailImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LevelOfDetailImpl extends MinimalEObjectImpl.Container implements LevelOfDetail {
	...
	public EList<ModelReference> getReferences() {
		if (references == null) {
			references = new EObjectContainmentEList<>(ModelReference.class, this,
					SemanticZoomPackage.LEVEL_OF_DETAIL__REFERENCES);
		}
		return references;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SemanticZoomPackage.LEVEL_OF_DETAIL__ID, oldId, id));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SemanticZoomPackage.LEVEL_OF_DETAIL__REFERENCES:
