...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Zoom Level</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ZoomLevelImpl extends MinimalEObjectImpl.Container implements ZoomLevel {
	/**
	...
	protected EClass eStaticClass() {
		return InteractivityPackage.Literals.ZOOM_LEVEL;
	}
	...
	public EList<Action> getActions() {
		if (actions == null) {
			actions = new EObjectResolvingEList<>(Action.class, this, InteractivityPackage.ZOOM_LEVEL__ACTIONS);
		}
		return actions;
	}
	...
	public void setLevel(int newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractivityPackage.ZOOM_LEVEL__LEVEL, oldLevel,
					level));
	}
