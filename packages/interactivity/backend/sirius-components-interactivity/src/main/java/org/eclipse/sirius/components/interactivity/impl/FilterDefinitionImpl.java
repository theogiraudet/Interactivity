 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.interactivity.impl.FilterDefinitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.interactivity.impl.FilterDefinitionImpl#getModifiers <em>Modifiers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FilterDefinitionImpl extends MinimalEObjectImpl.Container implements FilterDefinition {
	...
	protected EClass eStaticClass() {
		return InteractivityPackage.Literals.FILTER_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InteractivityPackage.FILTER_DEFINITION__NAME, oldName,
					name));
	}
	...
	public EList<ScopedModifier> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectContainmentEList<ScopedModifier>(ScopedModifier.class, this,
