...
public class InteractivityImpl extends MinimalEObjectImpl.Container implements Interactivity {
	...
	public EList<InteractiveFeature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<InteractiveFeature>(InteractiveFeature.class, this,
	...
	public EList<FilterDefinition> getFilters() {
		if (filters == null) {
			filters = new EObjectContainmentEList<FilterDefinition>(FilterDefinition.class, this,
